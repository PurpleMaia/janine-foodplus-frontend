...
import { getAllBillProposals, getPendingUserRequests, getPendingSupervisorRequests } from '../db/admins';
...
export async function getAdminDashboardData() {
  ...
  try {
    const [proposals, userRequests, supervisorRequests] = await Promise.all([
      getAllBillProposals(),      
    ...
    return {
      ...
      data: {        
        ...
        pendingSupervisorRequests: supervisorRequests
      },
    };
  } catch (e) {
